# Week 6 Setup - Agentic AI & LangGraph
...
## Prerequisites
- Completed Week 5 setup (technical indicators, market data collection)
...
2. Activate virtual environment (if not already):
   ...
   ```
3. Install langgraph and any needed dependencies:
   ```bash
...
4. Verify installation:
   ...
   ```
5. Create a notebook to explore LangGraph concepts:
   ```bash
