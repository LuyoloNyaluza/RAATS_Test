# Week 10 Setup - Evaluation Framework
...
## Prerequisites
- Completed Week 9 setup (system scalability, docker-compose)
...
2. Activate virtual environment (if not already):
   ...
   ```
3. Decide on a backtesting library (e.g., backtrader for simplicity, zipline if preferred).
4. Install the library and any dependencies.
   ```bash
   ...
   ```
5. Create a notebook to explore the library basics.
   ```bash
