...
2. Review all weekly reflections and deliverables to gather content for the report.
3. Create a structured outline for the final project report.
4. Start writing the introduction and methodology sections.
