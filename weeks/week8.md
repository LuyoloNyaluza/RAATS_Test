# Week 8: Integration: End‑to‑End Paper Trading
...
2. Create a simulation orchestrator that loops over historical dates, runs the agent graph for each day, and tracks portfolio.
